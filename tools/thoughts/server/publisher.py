...
GIST_ID = "a783c548bd3c7b22578a4bd3748bc9d5"
GIST_FILE = "thoughts.json"


def github_write(content):
    token_file = Path(os.environ.get("THOUGHTS_GIST_TOKEN_FILE", str(Path.home() / ".local/share/naro-thoughts/gist-token")))
